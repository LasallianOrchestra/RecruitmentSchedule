const CACHE='lso-recruitment-supabase-shell-v1';
const ASSETS=['./','./index.html','./styles.css','./app.js','./supabase-config.js','./manifest.webmanifest','./assets/lso-logo.png','./assets/icon-192.png','./assets/icon-512.png'];
