const CACHE='lso-recruitment-supabase-shell-v3';
const ASSETS=['./','./index.html','./styles.css','./app.js','./supabase-config.js','./manifest.webmanifest','./lso-logo.png','./icon-192.png','./icon-512.png'];
